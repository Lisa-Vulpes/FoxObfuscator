...
public class Engine {
    ...
    public String obfuscateText(String _text) {
        ...
        return new String(sb).replace(_keyChar + "9", _keyChar + "09").replace(
                _keyChar + "a", _keyChar + "0a");
    }
        ...
        while (i < _text.length()) {
            ...
            if (choppedText[i].matches(_keyChar)) {
                ...
                if (choppedText[i + 1].matches("9")) {
                    ...
                    // separator character.
                    sb.append(new String(DatatypeConverter
                            .parseHexBinary(LINE_SEPARATOR)));
                    i = i + 2;
                    ...
                    // code.
                    sb.append(new String(DatatypeConverter
                            .parseHexBinary(choppedText[i + 1]
                                    + choppedText[i + 2])));
                    i = i + 3;
                }
            } else {
